...
from components.alumnos.modelo_alumnos import AlumnoBase, AlumnoList, AlumnoSinId
from components.mesas.modelo_mesas import MesaBase, MesaList, MesaSinId
...
SQLALCHEMY_DATABASE_URL = "postgresql+psycopg2://postgres:sabalero12@localhost:5432/mydb"
